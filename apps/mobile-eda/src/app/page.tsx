...
export default function Index() {
  ...
  const handleLike = async () => {
    ...
    try {
      ...
      setLastResponse({ error: 'Failed to publish to Kafka' });
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-800 mb-2">
              Mobile EDA - Like Event Demo
            </h1>
            <p className="text-gray-600">
              Click the button to publish a like event to Kafka topic{' '}
              <code>post_liked</code>
            </p>
          </div>
          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            >
              <span className="flex items-center space-x-2">
                ...
                <span>
                  {loading ? 'Publishing Like...' : 'Publish Like Event'}
                </span>
              </span>
            </button>
            ...
            <div className="w-full mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                ...
                <li>
                  • Server Action publishes an event to Kafka via{' '}
                  <code>@io/messaging-util</code>
                </li>
                <li>
                  • Topic: <code>post_liked</code>, key: <code>postId</code>
                </li>
                <li>• Result (success/failure + IDs) is displayed in the UI</li>
              </ul>
            </div>
          </div>
        </div>
